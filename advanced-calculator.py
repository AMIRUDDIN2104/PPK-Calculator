...
class Calc(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("PPK Scientific Calculator")
        self.setGeometry(100, 100, 420, 750)
        ...
        gridLayout.addWidget(btnAllClear, 5, 4)
        ...
        gridLayout.addWidget(btnsq, 8, 3)
        ...
        gridLayout.addWidget(btnAdd, 7, 3)

        # Rest of the buttons
        operations = [
            ('-', 7, 4, lambda: self.operation("sub")),
            ('×', 6, 3, lambda: self.operation("multi")),
            ('÷', 6, 4, lambda: self.operation("divide")),
            ('0', 8, 0, lambda: self.numberEnter(0)),
            ('.', 8, 1, lambda: self.numberEnter('.')),
            ('±', 8, 2, self.mathPM),
            ('=', 8, 4, self.sum_of_total)
        ]
        ...
        scientific_buttons = [
            ...
            ('2π', 1, 1, self.tau), ('cosh', 1, 2, self.cosh), ('tanh', 1, 4, self.tanh), ('sinh', 1, 3, self.sinh),
            ('log', 3, 0, self.log), ('eˣ', 4, 0, self.exp), ('Mod', 4, 4, lambda: self.operation("mod")), ('e', 4, 2, self.e),
            ('log₁₀', 2, 0, self.log10), ('ln(1+x)', 3, 1, self.log1p), ('eˣ⁻¹', 4, 1, self.expm1), ('gamma', 4, 3, self.lgamma),
            ('log₂', 2, 1, self.log2), ('deg', 3, 2, self.degrees), ('cosh⁻¹', 3, 3, self.acosh), ('sinh⁻¹', 3, 4, self.asinh)
        ]
        ...
        exitAction.triggered.connect(self.iExit)
